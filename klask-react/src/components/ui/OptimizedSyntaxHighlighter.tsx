...
const getTheme = (styleName: string, isDarkMode: boolean): PrismTheme => {
    ...
    return (
        themeMap[styleName] || (isDarkMode ? themes.vsDark : themes.oneLight)
    );
};
            ...
            >
                <div className="mb-4 p-2 bg-yellow-100 dark:bg-yellow-900 border-l-4 border-yellow-400 text-yellow-700 dark:text-yellow-200">
                    ...
                    <p className="text-sm">
                        ...
                        {(children.length / 1024).toFixed(1)}KB). Syntax
                        highlighting has been disabled for performance.
                    </p>
                </div>
                        ...
                        {tokens.map((line, lineIndex) => (
                            <div
                                ...
                                style={{
                                    ...
                                    whiteSpace: wrapLongLines
                                        ? "pre-wrap"
                                        : "pre",
                                    wordBreak: wrapLongLines
                                        ? "break-word"
                                        : "normal",
                                }}
                            >
