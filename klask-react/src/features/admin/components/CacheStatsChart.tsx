  ...
  return (
    <div className={`space-y-6 ${className}`}>
      ...
      <div className={`${hitRatioBgColor} border-2 ${hitRatioColor} rounded-lg p-6 text-center`}>
        <p className="text-sm font-medium text-gray-600 dark:text-gray-400 mb-2">Cache Hit Ratio</p>
      ...
      <div>
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-sm font-semibold text-gray-900 dark:text-white">Hit/Miss Distribution</h3>
        ...
        <div className="flex items-end gap-2 mb-6">
          ...
          <div className="flex-1">
            <div className="flex items-end justify-between mb-2">
              <span className="text-xs font-medium text-gray-600 dark:text-gray-400">Cache Hits</span>
              <span className="text-sm font-bold text-green-600 dark:text-green-400">
                {cache.hits.toLocaleString()}
              </span>
            </div>
            <div className="h-32 bg-green-100 dark:bg-green-900/20 border-2 border-green-300 dark:border-green-800 rounded-lg relative overflow-hidden">
              <div
          ...
          <div className="flex-1">
            <div className="flex items-end justify-between mb-2">
              <span className="text-xs font-medium text-gray-600 dark:text-gray-400">Cache Misses</span>
              <span className="text-sm font-bold text-red-600 dark:text-red-400">
                {cache.misses.toLocaleString()}
              </span>
            </div>
            <div className="h-32 bg-red-100 dark:bg-red-900/20 border-2 border-red-300 dark:border-red-800 rounded-lg relative overflow-hidden">
              <div
      ...
      <div className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4">
        <div className="flex items-center justify-between">
          <div>
            <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Cached Entries</p>
